function stitched_img = stitchManyImg(varargin)
%{ 
...
for i = 2 : num_images
    ...
    homographies(:,:,i) = homographies(:,:,i-1)*H_3x3;
    
    boundingBoxSource = [1 1;src_img_width 1;1 src_img_ht;src_img_width src_img_ht];
    baseImageBoundingBox = applyHomography(homographies(:,:,i),boundingBoxSource);
